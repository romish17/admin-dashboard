    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Stay updated with your favorite sources</p>
        </div>
            ...
            <div className="space-y-1">
              <button
                ...
                className={cn(
                  ...
                  !selectedFeed ? 'bg-primary/20 text-primary' : 'text-muted-foreground hover:bg-muted'
                )}
              >
                All Feeds
              </button>
              {feeds.map((feed) => (
                <div
                  ...
                  className={cn(
                    ...
                    selectedFeed === feed.id ? 'bg-primary/20 text-primary' : 'text-muted-foreground hover:bg-muted'
                  )}
                >
                  <button
                  ...
                  <div className="flex items-center gap-1">
                    {feed.unreadCount ? (
                      <span className="badge bg-primary/20 text-primary">{feed.unreadCount}</span>
                    ) : null}
                    <button
        ...
        <div className="flex-1">
          {isLoading ? (
            ...
            <div className="card text-center py-12">
              <p className="text-muted-foreground">No items found. Add some RSS feeds!</p>
            </div>
          ) : (
